...
/* â”€â”€ Line Chart SVG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Bar Chart SVG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Funnel Chart â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Modal Shell â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Section head â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                // Loading animation failed â€” silently ignore to avoid breaking the UI
            }
        })();
    }, []);
    ...
    return (
      ...
      `}</style>
            ...
            <div style={{ minHeight: "100vh", background: "#f0f4fb" }}>
                ...
                {/* â•â• TOP NAVIGATION BAR â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
                <header style={{
                                    ...
                                    <div>
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
                                            ...
                                            <span style={{ fontSize: 12.5, color: C.s500, fontWeight: 600 }}>
                                                {company.followers} followers Â· {company.connections}
                                            </span>
                                        </div>
                                    </div>
                                        ...
                                        people.map((person) => (
                                            <div key={person.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: 14, borderRadius: 14, background: C.s50, border: `1px solid ${C.s100}` }}>
                                                ...
                                                <div style={{ flex: 1, minWidth: 0 }}>
                                                    ...
                                                    <div style={{ fontSize: 12, color: C.s500 }}>{person.role}{person.location ? ` Â· ${person.location}` : ""}</div>
                                                </div>
                                                <button onClick={() => handleRequestChat()} style={{ width: 32, height: 32, borderRadius: 9, border: "none", background: "#EEF2FF", color: C.navy, cursor: "pointer", flexShrink: 0 }}>
                                                    <FiMail size={13} />
                                                </button>
                                            </div>
                                        ))
                                ...
                                <div style={{ padding: "16px 20px", borderTop: `1px solid ${C.s100}`, background: C.s50 + "50" }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                                        <div style={{ fontSize: 12.5, color: C.s500, fontWeight: 600 }}>
                                            Showing page {reviewPage + 1} of {totalReviewPages} Â· {companyReviews.length} total reviews
                                        </div>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                        ...
                        <Card className="ep-card" style={{ padding: "18px" }}>
                            ...
                            {(topMatches.length ? topMatches : []).slice(0, 5).map((c, i) => (
                                <div key={c.id} style={{
                                    ...
                                    <button onClick={() => handleRequestChat(c.id)}
                        ...
                        <Card className="ep-card" style={{ padding: "18px", background: `linear-gradient(135deg,#fffbeb,#fef3c7)`, border: `1px solid #fde68a` }}>
                            <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
                                ...
                                <div>
                                    <div style={{ fontFamily: C.fd, fontSize: 14, fontWeight: 800, color: "#78350f" }}>Premium X Hiring Suite</div>
                                    <div style={{ fontSize: 11.5, color: "#92400e" }}>Source, screen, and close roles faster</div>
                                </div>
                            </div>
                ...
                <Modal open={showUpgradeModal} onClose={() => setShowUpgradeModal(false)} title="Upgrade to Premium X" width={520}>
                    <div style={{ padding: 12 }}>
                        ...
                        <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
                            ...
                            <Btn variant="green" onClick={() => { setShowUpgradeModal(false); navigate('/pricing'); }}>Upgrade to Premium X</Btn>
                        </div>
                    </div>
                </Modal>
            )}
                    ...
                    <div style={{ width: 260, borderRight: `1px solid ${C.s100}`, overflowY: "auto", flexShrink: 0 }}>
                        <div style={{ padding: "12px 16px", borderBottom: `1px solid ${C.s100}` }}>
                            <div style={{
                                ...
                                <input style={{ background: "none", border: "none", fontSize: 12.5, color: C.s900, width: "100%", fontFamily: C.dm }} placeholder="Search messagesâ€¦" />
                            </div>
                        </div>
                        {messages.map((conv, i) => (
            ...
            <Modal open={showPro} onClose={() => setShowPro(false)} title="Premium X - Supercharge Hiring" width={760}>
                <div style={{
                    ...
                    <div>
                        <div style={{ fontFamily:C.fd, fontSize:18, fontWeight:800, color:"#78350f", marginBottom:4 }}>Premium X Hiring Suite</div>
            ...
            <Modal open={showPost} onClose={() => setShowPost(false)} title="Post a New Job" width={620}>
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    {[
                        ...
                        { label: "Location", placeholder: "e.g. Bengaluru Â· Hybrid", type: "text" },
                        { label: "Salary Range", placeholder: "e.g. â‚¹18â€“26 LPA", type: "text" },
                    ].map((f, i) => (
                        <div key={i}>
                    ...
                    <div>
                        ...
                        <textarea placeholder="Describe the role, responsibilities, and requirementsâ€¦" rows={5}
                            style={{
                                width: "100%", padding: "10px 14px", borderRadius: 10, border: `1.5px solid ${C.s200}`,
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                        ...
                        <div>
                            ...
                            <select style={{
                                ...
                                <option>Mid-level (3â€“5 yrs)</option><option>Entry level</option><option>Senior (5â€“8 yrs)</option><option>Lead / Principal</option>
                            </select>
                        </div>
                    </div>
                    {/* Urgency toggle */}
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "16px", background: C.s50, borderRadius: 12, border: `1px solid ${C.s100}` }}>
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: 13, color: C.s500 }}>{selectedJob.dept} Â· {selectedJob.loc}</div>
                            </div>
                        </div>
